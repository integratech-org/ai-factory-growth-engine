...
def get_latest_10k(ticker: str) -> dict | None:
    ...
    try:
        ...
        # depending on version/call signature. Normalize to a single
        # filing object here so the rest of this function doesn't need
        # to care which shape it got.
        ...
        filing = cast(EntityFiling, latest)
