...
class AgentState:
    ...
    # ── Report output ─────────────────────────────────────────────────
    # Final markdown generated by the report node for UI consumption.
...
def get_companies(state: dict | AgentState) -> list[CompanyState]:
    ...
    # LangGraph Studio can sometimes send a wrapped shape like
    # {"companies": {"companies": [...]}} when manually editing node state.
    # Unwrap it defensively so downstream nodes still receive company records.
