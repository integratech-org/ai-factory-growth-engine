...
def render_weights_panel() -> dict[str, float]:
    ...
    # Use a container with border - matching input_tickers style
    with st.container(border=True):
        ...
        with col_title:
            st.markdown(
                ...
                <div style="display: flex; align-items: center; gap: 0.5rem; margin-bottom: 1rem;">
                    ...
                    <span style="font-weight: 600; font-size: 1rem; color: #1f2937;">Strategic Factor Weights</span>
                </div>
                """,
        ...
        with col1:
            ...
            st.write("")  # Spacer between sliders
